...
// (Eliminar), both currentColor so CSS controls their color per the surface
// (Danger) the mobile icon button underneath them resolves to. The pencil
// that used to back Editar is gone with the menu entry itself.
